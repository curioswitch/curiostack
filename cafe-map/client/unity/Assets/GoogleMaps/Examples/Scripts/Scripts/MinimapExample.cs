...
public sealed class MinimapExample : MonoBehaviour {
  ...
  [Tooltip("Should ground quad be included in the Minimap? These values must be set before play "
      + "starts to have an effect.")]
  public bool ShowGround;

  [Tooltip("Should regions be included in the Minimap? These values must be set before play starts "
      + "to have an effect.")]
  public bool ShowRegions = true;

  [Tooltip("Should segments (roads) be included in the Minimap? These values must be set before "
      + "play starts to have an effect.")]
  public bool ShowSegments = true;

  [Tooltip("Should water be included in the Minimap? These values must be set before play starts "
      + "to have an effect.")]
  public bool ShowWater = true;

  [Tooltip("Should extruded structures be included in the Minimap? These values must be set before "
      + "play starts to have an effect.")]
  public bool ShowExtruded;

  [Tooltip("Should modeled structures be included in the Minimap? These values must be set before "
      + "play starts to have an effect.")]
