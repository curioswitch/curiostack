...
/// <summary>
/// Example demonstrating how one can squash buildings in the vicinity of a player character avatar.
/// </summary>
/// <remarks>
...
public sealed class BuildingSquashing : MonoBehaviour {
  ...
  private void Start () {
    ...
    MapsService.Events.ExtrudedStructureEvents.WillCreate.AddListener(e => {
      e.Style = RandomizeBuildingHeight(e.Style);
    });
  ...
  private void DoLoadVisibleMap() {
    ...
    MapsService.MakeMapLoadRegion().AddViewport(Camera.main)
