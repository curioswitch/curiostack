...
/// </summary>
/// <remarks>
/// This example is almost identical to the Nine Slicing example. The only difference is the use of
/// the <see cref="Extruder"/> class to add modelled borders to the bases of buildings.
/// <para>
...
/// times.
/// </para><para>
/// Also uses <see cref="BuildingTexturer"/> component to apply Nine-Sliced <see cref="Material"/>s.
/// </para>
