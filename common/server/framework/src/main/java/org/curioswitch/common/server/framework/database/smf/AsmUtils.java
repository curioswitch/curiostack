 ...
 *
 * Most of the content is the same as org.simpleflatmapper.reflect.asm.AsmUtils,
...
public class AsmUtils {
    ...
    public static void invoke(MethodVisitor mv, String method,
                              Type target, String sig) {
