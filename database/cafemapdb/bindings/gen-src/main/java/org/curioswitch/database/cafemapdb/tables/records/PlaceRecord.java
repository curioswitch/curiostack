...
public class PlaceRecord extends UpdatableRecordImpl<PlaceRecord> implements Record7<ULong, String, Double, Double, String, LocalDateTime, LocalDateTime>, IPlace {

    private static final long serialVersionUID = -315707765;
     ...
     */
    @Override
    public Row7<ULong, String, Double, Double, String, LocalDateTime, LocalDateTime> fieldsRow() {
     ...
     */
    @Override
    public Row7<ULong, String, Double, Double, String, LocalDateTime, LocalDateTime> valuesRow() {
     ...
     */
    @Override
    public PlaceRecord values(ULong value1, String value2, Double value3, Double value4, String value5, LocalDateTime value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PlaceRecord(ULong id, String name, Double latitude, Double longitude, String instagramId, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Place.PLACE);
